"""Shared Telegram send helper -- Fixera Division.

Deliberately a duplicate of agents/forex/_telegram.py, not a cross-
import -- this project keeps Fixera and Forex division code fully
separate (see the 2026-07-22/23 session log on why), even for a
generic 12-line helper with no division-specific logic. Each division
gets its own copy so neither ever has to import from the other's
namespace.
"""
